...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void init()async {
    ...
    if(isConnected){
      bool isOnBoarding = CachedHelper.getBooleon(key: ConstantsManger.onBoadring)??false;
      if(isOnBoarding){
        ...
        if(mounted){
          Future.delayed(const Duration(seconds: 2), () => navigateToAndFinish(context, OnBoardingScreen()));
        }
      }
